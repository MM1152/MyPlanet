...
public class TowerItemViewer : MonoBehaviour
{
    ...
    public void SetData(RandomPickUpTable.Data data , bool isNew , (bool, float) isDuplication)
    {
        ...
        towerPieceImage.sprite = DataTableManager.TowerDuplicationRewardTable.GetData(data.connection_id, 1).TowerPieceItemData.ItemImage;
        towerPieceImage2.sprite = DataTableManager.TowerDuplicationRewardTable.GetData(data.connection_id, 1).TowerPieceItemData.ItemImage;
